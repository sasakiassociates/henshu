...
import React, { createContext, useContext, useState, useEffect, createElement } from 'react';
...
function Henshu(_a) {
    ...
    return (jsx(HenshuContext.Provider, __assign({ value: context }, { children: children }), void 0));
}
...
var EditableText = /** @class */ (function (_super) {
    ...
    EditableText.prototype.render = function () {
        ...
        return React.createElement(elem, __assign(__assign({}, htmlProps), { contentEditable: true, suppressContentEditableWarning: true, onBlur: function (e) { update(e, true); }, onFocus: function () { return _this.setState({ focused: true }); }, onInput: update, onPaste: update }), jsx(Fragment, { children: this.state.cached.trim() || 'Edit text here ...' }, void 0));
    };
    return EditableText;
}(React.Component));
var TextElements = [
...
TextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return createElement(EditableText, __assign(__assign({}, props), { elem: elem })); };
});
