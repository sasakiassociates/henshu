...
function EditableImage(props) {
    ...
    htmlProps['src'] = get();
    var node = htmlProps['src'] ? React.createElement(elem, htmlProps) : (jsxRuntime.jsx("div", __assign$1({ className: "Henshu__EditableImage empty ".concat(className) }, { children: jsxRuntime.jsx("em", { children: "..." }, void 0) }), void 0));
    return !editing ? node : (jsxRuntime.jsxs("div", __assign$1({ className: "Henshu__EditableImage ".concat(className) }, { children: [node, jsxRuntime.jsx(ReactDragDrop, { onLoad: onLoad }, void 0), htmlProps['src'] && jsxRuntime.jsx("button", __assign$1({ onClick: function () { return set(''); } }, { children: "Remove" }), void 0)] }), void 0));
}
var ImageElements = [
    'img'
];
...
function EditableRichText(_a) {
    ...
    var editor = React.useMemo(function () { return slateReact.withReact(slate.createEditor()); }, []);
    React.useEffect(function () {
        console.log(get());
        editor.children = JSON.parse(get() || p());
    }, [get]);
    return (jsxRuntime.jsx("div", __assign$1({}, props, { className: "Henshu__EditableRichText ".concat(props.className ? props.className : '') }, { children: jsxRuntime.jsxs(slateReact.Slate, __assign$1({ editor: editor, value: JSON.parse(get() || p()), onChange: function (v) { return set(JSON.stringify(v)); } }, { children: [editing && (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(MarkButton, { format: "bold", icon: "bold" }, void 0), jsxRuntime.jsx(MarkButton, { format: "italic", icon: "italic" }, void 0), jsxRuntime.jsx(BlockButton, { format: "heading-one", icon: "h1" }, void 0), jsxRuntime.jsx(BlockButton, { format: "heading-two", icon: "h2" }, void 0), jsxRuntime.jsx(BlockButton, { format: "bulleted-list", icon: "list" }, void 0)] }, void 0)), jsxRuntime.jsx(slateReact.Editable, { renderElement: renderElement, renderLeaf: renderLeaf, placeholder: editing ? 'Edit text here ...' : '...', spellCheck: true, autoFocus: true, readOnly: !editing }, void 0)] }), void 0) }), void 0));
}
...
RichTextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableRichText, __assign$1({}, props)); };
});
