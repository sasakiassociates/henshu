...
function EditableText(props) {
    ...
    var _a = React.useState(getter()), cached = _a[0], setCached = _a[1];
...
function EditableImage(props) {
    ...
    return !editing ? node : (jsxRuntime.jsxs("div", __assign$1({ className: "Henshu__EditableImage" }, { children: [node, jsxRuntime.jsx(ReactDragDrop, { onLoad: onLoad }, void 0), htmlProps['src'] && jsxRuntime.jsx("button", __assign$1({ onClick: function () { return setter(''); } }, { children: "Remove" }), void 0)] }), void 0));
}
var ImageElements = [
    'img'
];
