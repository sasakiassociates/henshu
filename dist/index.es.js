...
import React, { createContext, useContext, useState, useEffect, createElement, Component, forwardRef, useImperativeHandle, Fragment as Fragment$1, useRef, useReducer, useCallback, useMemo } from 'react';
...
var EditableText = /** @class */ (function (_super) {
    ...
    EditableText.prototype.render = function () {
        ...
        return createElement(elem, __assign$1(__assign$1({}, htmlProps), { contentEditable: true, suppressContentEditableWarning: true, onBlur: function (e) { update(e, true); }, onFocus: function () { return _this.setState({ focused: true }); }, onInput: update, onPaste: update }), jsx(Fragment, { children: this.state.cached.trim() || 'Edit text here ...' }, void 0));
    };
    return EditableText;
}(Component));
var TextElements = [
...
var EditableImage = /** @class */ (function (_super) {
    __extends(EditableImage, _super);
    function EditableImage() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    EditableImage.prototype.onLoad = function (file) {
        return __awaiter$1(this, void 0, void 0, function () {
            var b64, encoded;
            return __generator$1(this, function (_a) {
                b64 = new Buffer(file.buffer).toString('base64');
                encoded = "data:" + file.mime + ";base64," + b64;
                this.props.setter(encoded);
                return [2 /*return*/];
            });
        });
    };
    EditableImage.prototype.render = function () {
        var _this = this;
        var editing = true;
        var _a = this.props, elem = _a.elem, getter = _a.getter, setter = _a.setter;
        var htmlProps = strip(this.props, ['elem', 'getter', 'setter', 'app', 'persist']);
        ...
        return !editing ? node : (jsxs("div", __assign$1({ className: "Henshu__EditableImage" }, { children: [node, jsx(ReactDragDrop, { onLoad: this.onLoad.bind(this) }, void 0), htmlProps['src'] && jsx("button", __assign$1({ onClick: function () { return setter(''); } }, { children: "Remove" }), void 0)] }), void 0));
    };
