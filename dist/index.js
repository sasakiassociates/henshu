...
function Henshu(_a) {
    ...
    return (jsxRuntime.jsx(HenshuContext.Provider, __assign$2({ value: context }, { children: children }), void 0));
}
...
function Each(props) {
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [Array.isArray(items) && items.map(function (item, i) {
                ...
                var ref;
                return editing ? (React.createElement(child.type, __assign$2(__assign$2({}, child.props), { key: child.key, ref: function (r) { return ref = r; }, onMouseEnter: function (e) {
            ...
            }), selection && (jsxRuntime.jsx("div", __assign$2({ className: "Henshu__Each-selection", style: selectionPosition }, { children: jsxRuntime.jsxs("div", __assign$2({ className: "Henshu__Each-toolbar" }, { children: [jsxRuntime.jsx("button", __assign$2({ className: items.length === 1 ? 'disabled' : '', disabled: items.length === 1, onClick: function () { return remove(selection.item); } }, { children: "x" }), void 0), jsxRuntime.jsx("button", __assign$2({ className: selection.i === 0 ? 'disabled' : '', disabled: selection.i === 0, onClick: function () { return move(selection.item, selection.i - 1); } }, { children: "\u2190" }), void 0), jsxRuntime.jsx("button", __assign$2({ className: selection.i === items.length ? 'disabled' : '', disabled: selection.i === items.length - 1, onClick: function () { return move(selection.item, selection.i + 1); } }, { children: "\u2192" }), void 0), jsxRuntime.jsx("button", __assign$2({ className: props.max !== undefined && items.length === props.max ? 'disabled' : '', disabled: props.max !== undefined && items.length === props.max, onClick: function () { return add(selection.i + 1); } }, { children: "+" }), void 0)] }), void 0) }), void 0))] }, void 0);
}
...
function EditableText(props) {
    ...
    return React.createElement(elem, __assign$2(__assign$2({}, htmlProps), { contentEditable: true, suppressContentEditableWarning: true, onBlur: function (e) { return update(e, true); }, onFocus: function () { return setFocused(true); }, onInput: update, onPaste: update, content: cached }), cached.trim() || 'Edit text here ...');
}
var TextElements = [
    'a',
    'b',
...
function fromEvent(evt) {
    return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
            if (isObject$3(evt) && isDataTransfer(evt)) {
...
var ReactDragDrop = function (_a) {
    ...
    return (React__default["default"].createElement("div", __assign$1({ className: "ReactDragDrop" }, getRootProps()),
        React__default["default"].createElement("input", __assign$1({}, getInputProps())),
...
function EditableImage(props) {
    ...
    var onLoad = React.useCallback(function (file) {
        var b64 = buffer.Buffer.from(file.buffer).toString('base64');
    ...
    htmlProps['src'] = get();
    var node = htmlProps['src'] ? React.createElement(elem, htmlProps) : (jsxRuntime.jsx("div", __assign$2({ className: "Henshu__EditableImage empty ".concat(className) }, { children: jsxRuntime.jsx("em", { children: "..." }, void 0) }), void 0));
    return !editing ? node : (jsxRuntime.jsxs("div", __assign$2({ className: "Henshu__EditableImage ".concat(className) }, { children: [node, jsxRuntime.jsx(ReactDragDrop, { onLoad: onLoad }, void 0), htmlProps['src'] && jsxRuntime.jsx("button", __assign$2({ onClick: function () { return set(''); } }, { children: "Remove" }), void 0)] }), void 0));
}
var ImageElements = [
    'img'
];
...
var react_1 = __importDefault(React__default["default"]);
var react_dom_1 = __importDefault(require$$1__default["default"]);
var isEqual_1 = __importDefault(isEqual_1$1);
var quill_1 = __importDefault(quill.exports);
...
function EditableRichText(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign$2({}, props, { className: "Henshu__EditableRichText ".concat(props.className ? props.className : '') }, { children: editing ? (jsxRuntime.jsx(lib, { theme: "snow", value: value, onChange: function (v) { setValue(v); set(v); } }, void 0)) : (jsxRuntime.jsx("div", { dangerouslySetInnerHTML: { __html: get() } }, void 0)) }), void 0));
}
...
TextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableText, __assign$2(__assign$2({}, props), { elem: elem })); };
});
ImageElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableImage, __assign$2(__assign$2({}, props), { elem: elem })); };
});
RichTextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableRichText, __assign$2({}, props)); };
});
