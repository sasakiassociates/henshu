...
var IconContext = React__default["default"].createContext && React__default["default"].createContext(DefaultContext$1);
...
function Tree2Element(tree) {
  return tree && tree.map(function (node, i) {
    return React__default["default"].createElement(node.tag, __assign$2({
      key: i
...
function GenIcon(data) {
  ...
  return function (props) {
    return React__default["default"].createElement(IconBase, __assign$2({
...
function IconBase(props) {
  var elem = function (conf) {
    ...
    return React__default["default"].createElement("svg", __assign$2({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
...
function Each(props) {
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [Array.isArray(items) && items.map(function (item, i) {
                ...
                var ref;
                return editing ? (React.createElement(child.type, __assign$3(__assign$3({}, child.props), { key: child.key, ref: function (r) { return ref = r; }, onMouseEnter: function (e) {
...
function EditableText(props) {
    ...
    return React.createElement(elem, __assign$3(__assign$3({}, htmlProps), { contentEditable: true, suppressContentEditableWarning: true, onBlur: function (e) { return update(e, true); }, onFocus: function () { return setFocused(true); }, onInput: update, onPaste: update, content: cached }), cached.trim() || 'Edit text here ...');
}
var TextElements = [
    'a',
    'b',
...
function EditableImage(props) {
    ...
    htmlProps['src'] = get();
    var node = htmlProps['src'] ? React.createElement(elem, htmlProps) : (jsxRuntime.jsx("div", __assign$3({ className: "Henshu__EditableImage empty ".concat(className) }, { children: jsxRuntime.jsx("em", { children: "..." }) })));
    return !editing ? node : (jsxRuntime.jsxs("div", __assign$3({ className: "Henshu__EditableImage ".concat(className) }, { children: [node, jsxRuntime.jsx(ReactDragDrop, { onLoad: onLoad }), htmlProps['src'] && jsxRuntime.jsx("button", __assign$3({ onClick: function () { return set(''); } }, { children: "Remove" }))] })));
}
var ImageElements = [
    'img'
];
...
TextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableText, __assign$3(__assign$3({}, props), { elem: elem })); };
});
ImageElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableImage, __assign$3(__assign$3({}, props), { elem: elem })); };
});
RichTextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return React.createElement(EditableRichText, __assign$3({}, props)); };
});
...
function Henshu(_a) {
    ...
    return (jsxRuntime.jsx(HenshuContext.Provider, __assign$3({ value: context }, { children: children })));
}
