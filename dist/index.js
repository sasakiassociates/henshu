...
function Each(props) {
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [Array.isArray(items) && items.map(function (item, i) {
            ...
            }), selection && (jsxRuntime.jsx("div", __assign$2({ className: "Henshu__Each-selection", style: selectionPosition }, { children: jsxRuntime.jsxs("div", __assign$2({ className: "Henshu__Each-toolbar" }, { children: [jsxRuntime.jsx("button", __assign$2({ className: items.length === 1 ? 'disabled' : '', disabled: items.length === 1, onClick: function () { return remove(selection.item); } }, { children: "x" })), jsxRuntime.jsx("button", __assign$2({ className: selection.i === 0 ? 'disabled' : '', disabled: selection.i === 0, onClick: function () { return move(selection.item, selection.i - 1); } }, { children: "\u2190" })), jsxRuntime.jsx("button", __assign$2({ className: selection.i === items.length ? 'disabled' : '', disabled: selection.i === items.length - 1, onClick: function () { return move(selection.item, selection.i + 1); } }, { children: "\u2192" })), jsxRuntime.jsx("button", __assign$2({ className: props.max !== undefined && items.length === props.max ? 'disabled' : '', disabled: props.max !== undefined && items.length === props.max, onClick: function () { return add(selection.i + 1); } }, { children: "+" }))] })) })))] });
}
...
function EditableText(props) {
    ...
    if (!editing) {
        return React.createElement(elem, htmlProps, jsxRuntime.jsx(jsxRuntime.Fragment, { children: get() || '...' }));
    }
...
function EditableImage(props) {
    ...
    htmlProps['src'] = get();
    var node = htmlProps['src'] ? React.createElement(elem, htmlProps) : (jsxRuntime.jsx("div", __assign$2({ className: "Henshu__EditableImage empty ".concat(className) }, { children: jsxRuntime.jsx("em", { children: "..." }) })));
    return !editing ? node : (jsxRuntime.jsxs("div", __assign$2({ className: "Henshu__EditableImage ".concat(className) }, { children: [node, jsxRuntime.jsx(ReactDragDrop, { onLoad: onLoad }), htmlProps['src'] && jsxRuntime.jsx("button", __assign$2({ onClick: function () { return set(''); } }, { children: "Remove" }))] })));
}
var ImageElements = [
    'img'
];
...
function EditableRichText(_a) {
    ...
    return (jsxRuntime.jsx("div", __assign$2({}, props, { className: "Henshu__EditableRichText ".concat(props.className ? props.className : '') }, { children: editing ? (jsxRuntime.jsx(lib, { theme: "snow", value: value, onChange: function (v) { setValue(v); set(v); } })) : (jsxRuntime.jsx("div", { dangerouslySetInnerHTML: { __html: get() } })) })));
}
...
function Henshu(_a) {
    ...
    return (jsxRuntime.jsx(HenshuContext.Provider, __assign$2({ value: context }, { children: children })));
}
