...
import React, { createContext, useContext, useState, useEffect, useCallback, createElement, useMemo, useRef, useReducer, forwardRef, useImperativeHandle, Fragment as Fragment$1 } from 'react';
...
function Henshu(_a) {
    ...
    return (jsx(HenshuContext.Provider, __assign$2({ value: context }, { children: children }), void 0));
}
...
function Each(props) {
    ...
    return jsxs(Fragment, { children: [Array.isArray(items) && items.map(function (item, i) {
            ...
            }), selection && (jsx("div", __assign$2({ className: "Henshu__Each-selection", style: selectionPosition }, { children: jsxs("div", __assign$2({ className: "Henshu__Each-toolbar" }, { children: [jsx("button", __assign$2({ className: items.length === 1 ? 'disabled' : '', disabled: items.length === 1, onClick: function () { return remove(selection.item); } }, { children: "x" }), void 0), jsx("button", __assign$2({ className: selection.i === 0 ? 'disabled' : '', disabled: selection.i === 0, onClick: function () { return move(selection.item, selection.i - 1); } }, { children: "\u2190" }), void 0), jsx("button", __assign$2({ className: selection.i === items.length ? 'disabled' : '', disabled: selection.i === items.length - 1, onClick: function () { return move(selection.item, selection.i + 1); } }, { children: "\u2192" }), void 0), jsx("button", __assign$2({ className: props.max !== undefined && items.length === props.max ? 'disabled' : '', disabled: props.max !== undefined && items.length === props.max, onClick: function () { return add(selection.i + 1); } }, { children: "+" }), void 0)] }), void 0) }), void 0))] }, void 0);
}
...
var ReactDragDrop = function (_a) {
    ...
    return (React.createElement("div", __assign$1({ className: "ReactDragDrop" }, getRootProps()),
        React.createElement("input", __assign$1({}, getInputProps())),
...
function EditableImage(props) {
    ...
    var onLoad = useCallback(function (file) {
        var b64 = Buffer$1.from(file.buffer).toString('base64');
    ...
    htmlProps['src'] = get();
    var node = htmlProps['src'] ? createElement(elem, htmlProps) : (jsx("div", __assign$2({ className: "Henshu__EditableImage empty ".concat(className) }, { children: jsx("em", { children: "..." }, void 0) }), void 0));
    return !editing ? node : (jsxs("div", __assign$2({ className: "Henshu__EditableImage ".concat(className) }, { children: [node, jsx(ReactDragDrop, { onLoad: onLoad }, void 0), htmlProps['src'] && jsx("button", __assign$2({ onClick: function () { return set(''); } }, { children: "Remove" }), void 0)] }), void 0));
}
var ImageElements = [
    'img'
];
...
function EditableRichText(_a) {
    ...
    return (jsx("div", __assign$2({}, props, { className: "Henshu__EditableRichText ".concat(props.className ? props.className : '') }, { children: editing ? (jsx(lib, { theme: "snow", value: value, onChange: function (v) { setValue(v); set(v); } }, void 0)) : (jsx("div", { dangerouslySetInnerHTML: { __html: get() } }, void 0)) }), void 0));
}
