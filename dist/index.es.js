...
function Henshu(_a) {
    ...
    var _b = useState(DefaultContext), context = _b[0], setContext = _b[1];
    useEffect(function () {
        setContext({
    ...
    return (jsx(HenshuContext.Provider, __assign$1({ value: context }, { children: children }), void 0));
}
...
function Each(props) {
    ...
    return jsxs(Fragment, { children: [Array.isArray(items) && items.map(function (item, i) {
                ...
                var ref;
                return editing ? (createElement(child.type, __assign$1(__assign$1({}, child.props), { key: child.key, ref: function (r) { return ref = r; }, onMouseEnter: function (e) {
            ...
            }), selection && (jsx("div", __assign$1({ className: "Henshu__Each-selection", style: selectionPosition }, { children: jsxs("div", __assign$1({ className: "Henshu__Each-toolbar" }, { children: [jsx("button", __assign$1({ className: items.length === 1 ? 'disabled' : '', disabled: items.length === 1, onClick: function () { return remove(selection.item); } }, { children: "x" }), void 0), jsx("button", __assign$1({ className: selection.i === 0 ? 'disabled' : '', disabled: selection.i === 0, onClick: function () { return move(selection.item, selection.i - 1); } }, { children: "\u2190" }), void 0), jsx("button", __assign$1({ className: selection.i === items.length ? 'disabled' : '', disabled: selection.i === items.length - 1, onClick: function () { return move(selection.item, selection.i + 1); } }, { children: "\u2192" }), void 0), jsx("button", __assign$1({ className: props.max !== undefined && items.length === props.max ? 'disabled' : '', disabled: props.max !== undefined && items.length === props.max, onClick: function () { return add(selection.i + 1); } }, { children: "+" }), void 0)] }), void 0) }), void 0))] }, void 0);
}
...
function EditableText(props) {
    ...
    return createElement(elem, __assign$1(__assign$1({}, htmlProps), { contentEditable: true, suppressContentEditableWarning: true, onBlur: function (e) { return update(e, true); }, onFocus: function () { return setFocused(true); }, onInput: update, onPaste: update }), jsx(Fragment, { children: cached.trim() || 'Edit text here ...' }, void 0));
}
var TextElements = [
    'a',
    'b',
...
var Dropzone = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment$1, null, children(_objectSpread$b(_objectSpread$b({}, props), {}, {
    open: open
  })));
});
...
var ReactDragDrop = function (_a) {
    ...
    return (React.createElement("div", __assign({ className: "ReactDragDrop" }, getRootProps()),
        React.createElement("input", __assign({}, getInputProps())),
        processing ? (React.createElement("div", null,
            React.createElement("p", { className: "processing-wait" }),
            React.createElement("span", null, "Processing, please wait..."))) : (isDragActive ? (React.createElement("div", null,
            React.createElement("span", null, "Drop the files here ..."))) : (React.createElement("div", null,
            React.createElement("span", null, "Drag 'n' drop some files here, or click to select files"))))));
};
...
var Element = function (_a) {
    ...
    switch (element.type) {
        case 'block-quote':
            return jsx("blockquote", __assign$1({}, attributes, { children: children }), void 0);
        case 'bulleted-list':
            return jsx("ul", __assign$1({}, attributes, { children: children }), void 0);
        case 'heading-one':
            return jsx("h1", __assign$1({}, attributes, { children: children }), void 0);
        case 'heading-two':
            return jsx("h2", __assign$1({}, attributes, { children: children }), void 0);
        case 'list-item':
            return jsx("li", __assign$1({}, attributes, { children: children }), void 0);
        case 'numbered-list':
            return jsx("ol", __assign$1({}, attributes, { children: children }), void 0);
        default:
            return jsx("p", __assign$1({}, attributes, { children: children }), void 0);
    }
};
var Leaf = function (_a) {
    var attributes = _a.attributes, children = _a.children, leaf = _a.leaf;
    if (leaf.bold) {
        children = jsx("strong", { children: children }, void 0);
    }
    if (leaf.code) {
        children = jsx("code", { children: children }, void 0);
    }
    if (leaf.italic) {
        children = jsx("em", { children: children }, void 0);
    }
    if (leaf.underline) {
        children = jsx("u", { children: children }, void 0);
    }
    return jsx("span", __assign$1({}, attributes, { children: children }), void 0);
};
var BlockButton = function (_a) {
    var format = _a.format, icon = _a.icon;
    var editor = useSlate();
    return (jsx("button", __assign$1({ active: isBlockActive(editor, format), onMouseDown: function (event) {
            event.preventDefault();
...
var MarkButton = function (_a) {
    var format = _a.format, icon = _a.icon;
    var editor = useSlate();
    return (jsx("button", __assign$1({ active: isMarkActive(editor, format), onMouseDown: function (event) {
            event.preventDefault();
...
TextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return createElement(EditableText, __assign$1(__assign$1({}, props), { elem: elem })); };
});
...
RichTextElements.forEach(function (elem) {
    henshu[elem] = function (props) { return createElement(EditableRichText, props); };
});
